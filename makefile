...
CFLAGS += -I/home/juliabennett/Desktop/embedded/Include -lm
LDFLAGS := -L/home/juliabennett/Desktop/embedded/lib -L/usr/lib/arm-none-eabi/newlib/thumb/v7e-m+fp/hard 
...
emb: $(OBJ) 
	$(LD) obj/* -Tgcc_arm.ld $(LIB) $(LDLIBS) -o embedded.img 
